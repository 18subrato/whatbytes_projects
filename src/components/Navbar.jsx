...
function Navbar() {
    ...
    return(
        <div className="bg-blue-600 max-w-screen flex px-10 py-8 justify-between">
            <div>
            ...
            <div className="flex gap-10">
                ...
                <button onClick={() => navigate('/cart')} className="flex bg-blue-950 justify-center items-center px-10 font-bold rounded-md text-white gap-2 cursor-pointer"><ShoppingCart/><span>Cart</span></button>
            </div>
        </div>
    )
}
